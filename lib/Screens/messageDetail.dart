    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: CircleAvatar(
            backgroundImage: NetworkImage("https://www.freecodecamp.org/news/"
          ...
          Column(mainAxisAlignment: MainAxisAlignment.start,
            ...
            children: [
              Padding(
                ...
                child: Text("Virat(You)",style: TextStyle(fontWeight:
                FontWeight.w400,color: Colors.white,fontSize: 15),),
              ),
            ],
          )
        ],
